//! `netcfg` — command-line front end for the `taktora-ethercat-netcfg` toolchain.
//!
//! A thin clap shell over [`taktora_ethercat_netcfg_cli`]. The real work lives in
...
use taktora_ethercat_netcfg_cli::{run_expand, run_fetch, run_verify};
