...
use taktora_ethercat_netcfg::PdoDirection;
use taktora_ethercat_netcfg_codegen::{Warning, generate, warnings};
...
fn config(yaml: &str) -> taktora_ethercat_netcfg::NetworkConfig {
    taktora_ethercat_netcfg::parse(yaml).expect("fixture parses")
}
